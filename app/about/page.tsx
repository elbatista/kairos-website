  ...
  const team = [
    {
      name: "Eliã Batista",
      role: "CEO/CTO",
      bio: "Received the PhD degree from Università della Svizzera italiana (USI), Switzerland, and PUCRS, Brazil (double-degree PhD), specializing in distributed systems, parallel state machine replication, and knowledge-driven AI. Passionate about scalable, dependable AI solutions.",
